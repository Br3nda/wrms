...
DELETE FROM request_quote WHERE NOT EXISTS ( SELECT 1 FROM request WHERE request_id = request_interested.request_id);
DELETE FROM request_timesheet WHERE NOT EXISTS ( SELECT 1 FROM request WHERE request_id = request_interested.request_id);
