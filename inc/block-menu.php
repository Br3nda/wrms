<?php
  ...
  if ( is_member_of('Request') ) {
    echo "<br><img class=\"block\"sep src=\"/$images/menuBreak.gif\" width=\"130\" height=\"9\">";
...
//    echo "<br>\n &nbsp;<a href=$base_url/requestlist.php?qs=complex class=\"block\" title=\"$tooltip\" alt=\"$tooltip\">Request&nbsp;Search</a>";
  ...
  if ( is_member_of('Admin', 'Support', 'Manage') ) {
    echo "<img class=\"block\"sep src=\"/$images/menuBreak.gif\" width=\"130\" height=\"9\">";
    ...
    echo "<br>\n &nbsp;<a href=\"$base_url/user.php?org_code=$session->org_code\" class=\"block\" title=\"$tooltip\" alt=\"$tooltip\">New&nbsp;User</a>";
  ...
  if ( is_member_of('Admin', 'Support' ) ) {
    echo "<br><img class=\"block\"sep src=\"/$images/menuBreak.gif\" width=\"130\" height=\"9\"><br>\n &nbsp;<a href=$base_url/timesheet.php class=\"block\">Timesheet Entry</a>";
    ...
    echo "<br>\n &nbsp;<a href=\"$base_url/form.php?user_no=$user_no&form=timelist&uncharged=1\" class=\"block\">My&nbsp;Uncharged&nbsp;Work</a>";
