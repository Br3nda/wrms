<html>
  ...
  <body>
    ...
    <h2>The Bad News</h2>
    <p>There is no configuration file present in <b>/etc/wrms/<?php echo $_SERVER['SERVER_NAME']; ?>-conf.php</b> so
       your installation is not fully set up.</p>
    <h2>The Good News</h2>
    <p>Well, you're seeing this! At least you have WRMS <i>installed</i> :-) You also have Apache and PHP working
       and so really you are well on the road to success!</p>
    <h2>The Dubious News</h2>
    <p>You could try and <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/docs/configuration.html">click here</a> and
