<?php
  ...
  if ( "$style" == "plain" )
    echo " | <a href=\"$base_url/requestlist.php\">List Requests</a>\n";
  echo "</font></td>\n";
  echo "<td class=row0 align=right nowrap width=\"3%\"><font size=1><form method=get action=\"/request.php\">\n";
  echo "Go to: </font></td>\n";
  echo "<td class=row0 align=right nowrap width=\"3%\"><font size=1>";
