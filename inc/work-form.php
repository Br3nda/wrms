...
<?php
  if ( "$search_for$system_id " != "" ) {
    ...
    if ( ! $result ) {
      ...
      echo           '</tr>';
      echo           '<tr>';
      echo             '<td><input TYPE="Image" src="/$theme->images/hide.gif" alt="Hide Work Description" BORDER="0" name="hide[request_timesheet.work_description]" ></td>';
      echo             '<td>Work Description</td>';
      echo           '</tr>';
      echo           '<tr>';
      echo             '<td></td>';
      echo             '<td align="middle"><input TYPE="Image" src="/'.$theme->images.'/down.gif" alt="Sort Descending" BORDER="0" name="sort[request_timesheet.work_description]" ></td>';
      echo           '</tr>';
      echo         '</table>';
      echo       "</th>\n";
      ...
      echo           '<img valign="middle" src="/'.$theme->images.'/date-picker.gif" border=0>';
      echo         '</a><br>';
